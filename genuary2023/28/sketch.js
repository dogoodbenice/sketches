let poetry = [];
let title;
let verse = ['Where did the love go?','Who should appear but you?','Pretty but lost','Feast or famine there is no between','Whisper or scream, just make the noise','It ended as it started','What does it all mean?','Who should we be?','Where should we go?','reason or not','look anywhere but here','I was right','I got the juice', 'Look upon thee', '', "you just don't know the words", '', 'I would like to be the air', 'NO,no,no', 'rocky rocket launcher', '', 'You have to try', 'Love at the lips', '', 'I was wrong', '', 'I have no time to stop and stare', 'My cup runeth over', 'Wu tang clan forever', 'Queens baby', 'nothing better than falling in love', 'rolling in green pastures', '', '', 'Of a surf-tormented shore,', 'Two roads diverged in a yellow wood', 'Now you understand', "They think Im telling lies", 'To cool in the peppermint wind', 'If you think it long and mad', 'but here alone', 'you want a better story', 'Cool face of the river', 'I am beating all my wings'];
let moveup;
